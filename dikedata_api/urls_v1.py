...
urlpatterns = patterns(
    ...
    url(r'^timeseries/search/?$',
        views.TimeseriesSearch.as_view(),
        name='timeseries-search'),
    url(r'^timeseries/behind/?$',
        views.TimeseriesBehind.as_view(),
        name='timeseries-behind'),
