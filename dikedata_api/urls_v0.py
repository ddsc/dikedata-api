...
urlpatterns = patterns(
    ...
    url(r'^datasets/(?P<pk>[^/]+)/$',
        ...
        name='dataset-detail'),
    url(r'^locationgroups/$',
        views.LocationGroupList.as_view(),
        name='locationgroup-list'),
    url(r'^locationgroups/(?P<pk>[^/]+)/$',
        views.LocationGroupDetail.as_view(),
        name='locationgroup-detail'),
    url(r'^locations/$',
